...
def train_model(model, train_loader):  # Train an epoch
    ...
    for step, batch in enumerate(tk):
        ...
        with autocast():
            ...
            merge_batch_src = batch_src
            merge_batch_trg = batch_trg
            # print(merge_batch_trg[0].shape())
            output0, output1 = model(batch_src,merge_batch_trg)
            loss1, acc1 = lossFunc(output0, output1)
            output0, output1 = model(batch_trg,merge_batch_src)
